      ...
      return Datatables::of($products)
          ->addColumn('action', function ($product) {
            ...
            //   }
              ...
              if (Auth::user()) {
                $btn .= '<a href="https://www.pos.mentosoftware.co.uk/public/admin/product-edit/'.$product->id.'" class="btn btn-sm btn-primary"><span title="Return"><i class="fa fa-pencil"></i>Edit</span></a>';
            }
